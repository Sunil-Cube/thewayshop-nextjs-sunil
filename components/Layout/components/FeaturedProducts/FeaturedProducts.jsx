            ...
            <div className="col-lg-3 col-md-6 special-grid best-seller">
                <div className="products-single fix">
                    <div className="box-img-hover">
                        ...
                        <img src={`/images/${product.featured_image}`} className="img-fluid" alt="Image" />
                    ...
                    <div className="why-text">
                        <h4>{product.name}</h4>
                        <h5>{product.currency}{product.selling_price}</h5>
                    </div>
                </div>
            </div>
        )
...
function FeaturedProducts(props) {
    const products = useSelector((state) => { return useMemo(() => state.products, [state.products]) })
    return (
